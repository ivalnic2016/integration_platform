...
original_author="ivalnic2016"
original_name="integration_platform"
original_urlname="integration_platform"
original_description="Awesome integration_platform created by ivalnic2016" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/integration_platform "${name}"
...
then
    ...
    echo "then run 'integration_platform' or 'python -m integration_platform'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'integration_platform' or 'python -m integration_platform' or 'poetry run integration_platform'"
fi
